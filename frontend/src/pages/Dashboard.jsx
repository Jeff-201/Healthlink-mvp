    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <Link
            to="/book-appointment"
            className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white rounded-xl p-6 shadow-lg transition-colors"
          >
            <div className="flex items-center justify-between">
              <div>
          ...
          <Link
            to="/view-records"
            className="bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 text-white rounded-xl p-6 shadow-lg transition-colors"
          >
            <div className="flex items-center justify-between">
              <div>
          ...
          <Link
            to="/contact-support"
            className="bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 text-white rounded-xl p-6 shadow-lg transition-colors"
          >
            <div className="flex items-center justify-between">
              <div>
